...
contract GasPriceFeesHook is BaseHook {
    error GasPriceFeesHook_MustUseDynamicFee();
    ...
    // Update the moving average gas price
    ...
    // if the gas price is within 10% range of the current avg gas price then keep the base fee same else change it
    ...
    function _beforeInitialize(
        ...
        if (!key.fee.isDynamicFee())
            revert GasPriceFeesHook_MustUseDynamicFee();
